"""Shared fixtures for settings HTTP router tests."""
...
@pytest.fixture
def mock_get_notification_prefs_use_case() -> AsyncMock:
    return AsyncMock()


@pytest.fixture
def mock_update_notification_prefs_use_case() -> AsyncMock:
    return AsyncMock()
...
async def async_client(
    ...
    app.dependency_overrides[get_get_notification_prefs_use_case] = lambda: (
        mock_get_notification_prefs_use_case
    )

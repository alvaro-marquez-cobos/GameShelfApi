"""Shared fixtures for search HTTP router tests."""
...
@pytest.fixture
def mock_search_use_case() -> AsyncMock:
    return AsyncMock()
...
async def async_client(
    ...
    app.dependency_overrides[get_search_games_use_case] = lambda: mock_search_use_case

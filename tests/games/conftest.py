"""Shared fixtures for games HTTP router tests."""
...
@pytest.fixture
def mock_get_game_detail_use_case() -> AsyncMock:
    return AsyncMock()


@pytest.fixture
def mock_get_game_dlcs_use_case() -> AsyncMock:
    return AsyncMock()
...
async def async_client(
    ...
    from composition.dependencies import (
        ...
        get_get_game_detail_use_case,
        get_get_game_dlcs_use_case,
        get_token_blacklist,
    )
    ...
    app.dependency_overrides[get_get_game_detail_use_case] = lambda: mock_get_game_detail_use_case
    app.dependency_overrides[get_get_game_dlcs_use_case] = lambda: mock_get_game_dlcs_use_case
